...
const features = [
  {
    icon: (
      <img width={48} height={48} src={Network} alt="Network" loading="lazy" />
    ),
  ...
  {
    icon: <img width={48} height={48} src={Scale} alt="Scale" loading="lazy" />,
  ...
  {
    icon: (
      <img width={48} height={48} src={Deploy} alt="Deploy" loading="lazy" />
    ),
