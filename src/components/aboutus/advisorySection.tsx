...
const AdvisorySection: React.FC = () => {
  return (
    <Box sx={{ py: { xs: 12, md: 15 }, background: "#fff", position: "relative", overflow: "hidden" }}>
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        <Box textAlign="center" mb={12}>
          ...
          >
            ...
            >
              Driving innovation through the collective wisdom of healthcare's most respected leaders.
            </Typography>
          </motion.div>
        </Box>
          ...
          {advisoryData.map((advisor, index) => (
            ...
            >
              <Box sx={{ 
                ...
                mb: 10,
                position: "relative",
                "&:hover .advisor-avatar": { transform: "scale(1.1) rotate(5deg)", boxShadow: "0 20px 40px rgba(107, 191, 89, 0.2)" },
