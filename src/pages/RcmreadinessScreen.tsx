...
type SectionProps = { title: string; icon?: React.ReactNode; items: ChecklistItem[] };

/* DATA */
const sections: SectionProps[] = [
  { title: "Correspondence Classification", icon: <FolderStyledIcon />, items: [
  ...
  { title: "Payment Posting & Reconciliation", icon: <PaymentsStyledIcon />, items: [
  ...
  { title: "EMR & Facility Complexity", icon: <HospitalStyledIcon />, items: [
  ...
  { title: "Operational Challenges", icon: <TimeStyledIcon />, items: [
  ...
  { title: "AI Compatibility & Readiness", icon: <AIStyledIcon />, items: [
  ...
  { title: "Organizational Readiness", icon: <HandshakeStyledIcon />, items: [
  ...
  { title: "Low Dollar Denials & Write-Offs", icon: <TrendingStyledIcon />, items: [
  ...
  { title: "Measurable Impact Potential", icon: <InsightsStyledIcon />, items: [
    ...
    <Container>
      <HeaderWrapper>
        <Stack spacing={2} mb={6}>
          ...
          <HeaderSubText>
            Use this checklist to determine if your organization is ready for AI-driven automation.
          </HeaderSubText>
        </Stack>
...
>
  Submit Assessment
        ...
        {submitted && (
          <ResultPaper elevation={0}>
            <Stack alignItems="center" spacing={2}>
              ...
              <Typography>Your Score: <strong>{score}</strong></Typography>
              <Typography>
                {score >= 15
        ...
        <FooterWrapper>
          <Typography variant="h5" color="#1e3a8a">Ready to automate your RCM workflows?</Typography>
          <Typography color="#374151">Contact us at</Typography>
          <FooterEmail variant="h6">info@cognitivehealthit.com</FooterEmail>
          <FooterCaption variant="caption">© CognitiveHealth – RCM Automation Solutions</FooterCaption>
        </FooterWrapper>
      </HeaderWrapper>
    </Container>
  );
