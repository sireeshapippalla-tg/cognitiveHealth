...
import { BlogHeader, BlogTitle, BlogDate, BlogDescription, Author, SectionTitle, SectionContent, OutcomeList, InlineImageContainer, InlineImage, ImageCaption } from "../BlogDetailPage.styles";
  ...
  <>
    <BlogHeader>
      ...
      <InlineImageContainer>
        <InlineImage src={IDPHeader} alt="Manual Document processing can be tedious" />
      </InlineImageContainer>
      <BlogDescription>
        {blog.description}
      </BlogDescription>
    ...
    <InlineImageContainer>
      <InlineImage src={IDP3} alt="Mine data from any document format with IDP" />
    ...
    <InlineImageContainer>
      <InlineImage src={IDP4} alt="Simplified flow of an implemented IDP Pipeline" />
