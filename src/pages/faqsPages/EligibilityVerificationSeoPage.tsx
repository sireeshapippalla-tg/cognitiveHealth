...
const EligibilityVerificationSeoPage = () => {
  ...
  return (
    <>
      <SEO
        title="Eligibility Verification And Denial Management AI Automation | CognitiveHealth"
        description="Enhance your revenue cycle with our advanced eligibility verification and denial management automation solutions. Discover how our tools can streamline operations and improve financial performance. Schedule a free consultation today."
        keywords="Eligibility, Verification, And, Denial, Management, AI, Automation, Healthcare RCM, Medical Billing, iCAN Platform"
        schema={schema}
      />
          ...
          <Container maxWidth="lg">
            ...
            >
              <Typography variant="h2" component="h1" fontWeight={700} gutterBottom sx={{ fontSize: { xs: '2.3rem', md: '3.3rem' }, lineHeight: 1.2 }}>
                Optimized Revenue Cycle with Eligibility Verification and Denial Management Automation
              </Typography>
                ...
                <Box mb={6}>
                  ...
                  <List sx={{ mb: 3 }}>
                    <ListItem sx={{ py: 0.5, px: 0 }}>
                      ...
                      <ListItemText primary="Accuracy and Efficiency:AI-driven Eligibility and automation and insurance discovery processensures that patient insurance information is verified accurately andpromptly, reducing the likelihood of claim denials due to eligibilityissues." primaryTypographyProps={{ color: 'text.secondary', fontSize: '1.05rem' }} />
                    </ListItem>
                    <ListItem sx={{ py: 0.5, px: 0 }}>
                      <ListItemIcon sx={{ minWidth: '32px' }}>
                        <CheckCircleOutlineIcon color="primary" fontSize="small" />
                      </ListItemIcon>
                      <ListItemText primary="Real-time Verification:Automated systems provide real-time verification, allowing healthcareproviders to confirm patient eligibility at the point of service." primaryTypographyProps={{ color: 'text.secondary', fontSize: '1.05rem' }} />
                    </ListItem>
                    <ListItem sx={{ py: 0.5, px: 0 }}>
                      <ListItemIcon sx={{ minWidth: '32px' }}>
                        <CheckCircleOutlineIcon color="primary" fontSize="small" />
                      </ListItemIcon>
                      <ListItemText primary="Cost Reduction:By minimizing manual intervention, automation reduces administrativecosts and frees up staff to focus on more strategic tasks." primaryTypographyProps={{ color: 'text.secondary', fontSize: '1.05rem' }} />
                    </ListItem>
                    <ListItem sx={{ py: 0.5, px: 0 }}>
                      <ListItemIcon sx={{ minWidth: '32px' }}>
                        <CheckCircleOutlineIcon color="primary" fontSize="small" />
                      </ListItemIcon>
                      <ListItemText primary="Enhanced Patient Experience:Faster eligibility verification enhances the patient experience byreducing wait times and ensuring transparency in coverage details." primaryTypographyProps={{ color: 'text.secondary', fontSize: '1.05rem' }} />
                    </ListItem>
                  </List>
                  <Box
                    component="img"
...
export default EligibilityVerificationSeoPage;
