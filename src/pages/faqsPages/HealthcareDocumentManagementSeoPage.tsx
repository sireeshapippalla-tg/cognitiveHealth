...
const HealthcareDocumentManagementSeoPage = () => {
  ...
  return (
    <>
      <SEO
        title="Healthcare Document Management With Generative AI | CognitiveHealth"
        description="Streamline your healthcare document management with our advanced AI solutions. Discover how our tools can enhance efficiency, reduce errors, and improve financial performance. Schedule a free demo today."
        keywords="Healthcare, Document, Management, With, Generative, AI, Healthcare RCM, Medical Billing, iCAN Platform"
        schema={schema}
      />
          ...
          <Grid container spacing={6}>
            ...
            <Grid size={{ xs: 12, md: 8 }}>
              ...
              >
                ...
                <Box mb={6}>
                  <Typography variant="body1" paragraph color="text.secondary" sx={{ fontSize: '1.05rem', lineHeight: 1.8 }}>
                    In the dynamic world of healthcare, automating critical processes such as document management and correspondence handling is essential for maintaining operational efficiency and compliance. CognitiveHealth's iCAN™ platform provides a comprehensive solution that addresses these challenges head-on, empowering healthcare providers to focus on delivering exceptional patient care.
                  </Typography>
                  <Typography variant="body1" paragraph color="text.secondary" sx={{ fontSize: '1.05rem', lineHeight: 1.8 }}>
                    By embracing automation, healthcare organizations can significantly reduce administrative burdens, enhance compliance, and improve overall performance. Experience the future of healthcare document management with CognitiveHealth's iCAN™ platform – a revolutionary approach to document automation and correspondence management.
                  </Typography>
                  <Typography variant="body1" paragraph color="text.secondary" sx={{ fontSize: '1.05rem', lineHeight: 1.8 }}>
                    For healthcare providers looking to optimize their document management processes, CognitiveHealth's iCAN™ platform offers a comprehensive, scalable, and efficient solution. Embrace the transformative power of AI in healthcare document management and take the first step towards operational excellence today.
                  </Typography>
                  <Typography variant="body1" paragraph color="text.secondary" sx={{ fontSize: '1.05rem', lineHeight: 1.8 }}>
...
export default HealthcareDocumentManagementSeoPage;
