...
const RcmAiBillingServicesSeoPage = () => {
  ...
  return (
    <>
      <SEO
        title="RCM AI-Powered Billing Services | CognitiveHealth"
        description="Discover how our advanced AI Powered RCM billing services can enhance your healthcare revenue cycle. Explore our solutions for automation, efficiency, and improved financial performance. Schedule a free consultation today."
        keywords="RCM, AI-Powered, Billing, Services, Healthcare RCM, Medical Billing, iCAN Platform"
        schema={schema}
      />
          ...
          <Container maxWidth="lg">
            ...
            >
              <Typography variant="h2" component="h1" fontWeight={700} gutterBottom sx={{ fontSize: { xs: '2.3rem', md: '3.3rem' }, lineHeight: 1.2 }}>
                RCM AI-Powered Billing Services
              </Typography>
...
export default RcmAiBillingServicesSeoPage;
