...
router.post('/send-results-pdf', upload.single('file'), async (req: Request, res: Response) => {
  try {
    ...
    await transporter.sendMail({
      ...
      html: `
        <p>Hello,</p>
        <p>Thank you for your interest! Please find our complete results package attached to this email.</p>
...
router.post('/our-implementation-process-pdf', upload.single('file'), async (req: Request, res: Response) => {
  try {
    ...
    await transporter.sendMail({
      ...
      html: `
        <p>Hello,</p>
        <p>Thank you for your interest! Please find our complete implementation process attached to this email.</p>
        <p>Best regards,<br/>The CognitiveHealth Team</p>
      `,
      attachments: [
